...
public class DijkstraAlgorithmUsingSet {
    // custom class to store {distance, node}
    static class Pair {
        int dist, node;
    ...
    public int[] dijkstra(int V, int[][] edges, int src) {
        ...
        TreeSet<Pair> set = new TreeSet<>((a, b) -> {
            return (a.dist != b.dist) ? Integer.compare(a.dist, b.dist)
                                      : Integer.compare(a.node, b.node);
        });
        // declare and initialize distance array with (int) 1e9
        int[] dist = new int[V];
    ...
    public static void main(String[] args) {
        var obj = new DijkstraAlgorithmUsingSet();
